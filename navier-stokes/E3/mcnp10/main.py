...
def main(cfg):
    ...
    logfile = f'log/seed_{cfg.seed}_Adam_{cfg.num_iterations}_{cfg.step_size}_{cfg.gamma}_{cfg.lr}_{timestring}.csv'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sup_u', type=int, default=2,
            help='sup_u')
    
    parser.add_argument('--sup_w', type=int, default=1,
            help='sup_w')
